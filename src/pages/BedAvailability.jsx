  ...
  return (
    <div className="bed-page">
      <div className="bed-content">
        <h1 className="bed-title">Live Bed Availability</h1>
        <p className="bed-subtitle">Real-time overview of bed availability across all departments</p>
        ...
        <div className="bed-summary-grid">
          {departments.map((dept) => (
            <div key={dept.name} className={`bed-summary-card ${dept.name === 'Emergency' ? 'bed-summary-emergency' : ''}`}>
              ...
              <div className="bed-summary-name">{dept.name}</div>
              <div className="bed-summary-number" style={{ color: dept.color }}>
                {dept.available}
              </div>
              <div className="bed-summary-label">Available</div>
              <div className="bed-summary-total">Total: {dept.total}</div>
            </div>
          ))}
        </div>
                  ...
                  <tr key={dept.name}>
                    <td>
                      <div className="bed-dept-cell">
                        ...
                        <span className="bed-dept-name">{dept.name}</span>
                      </div>
                    </td>
                    <td>{dept.total}</td>
                    ...
                    <td>
                      <span className="bed-availability-badge">{pct}% Available</span>
                    </td>
                  </tr>
                )
              })}
